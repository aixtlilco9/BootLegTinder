...
public class MainActivity extends AppCompatActivity {
    ...
    private void isConnectionMatch(String userId) {
        DatabaseReference currentUserConnectionDb = usersDb.child(userSex).child(currentUID).child("connections").child("hit").child(userId);
        currentUserConnectionDb.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    Toast.makeText(MainActivity.this, "Love is in the air!", Toast.LENGTH_LONG).show();
                    //in the below lines we are creating the matches
